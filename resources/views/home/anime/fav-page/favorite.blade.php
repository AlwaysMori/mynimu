...
<div class="container mx-auto px-4 mt-6">
    <h1 class="text-3xl font-bold text-white mb-4">Favorite Anime</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="photo-card bg-gray-800 p-6 border border-blue-800 fade-in rounded-none solid-shadow hover:shadow-lg transition flex relative">
                ...
                <div class="flex-1 pl-4">
                    ...
                    <div class="mt-4 flex justify-between">
                        ...
                        <form action="{{ url('/anime/bookmark/'.$bookmark->id) }}" method="POST" onsubmit="return confirm('Remove from favorite?')">
                            @csrf
                            @method('DELETE')
        ...
        @empty
            <p class="text-gray-400">You have no favorite anime yet.</p>
        @endforelse
    </div>
</div>
@endsection
