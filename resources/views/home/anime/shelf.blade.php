...
<body class="bg-gray-900 text-white min-h-screen mb-20 fade-in" style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="container mx-auto px-4 mt-6">
        ...
        <div id="anime-shelf" class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="photo-card bg-gray-800 p-6 border border-blue-800 fade-in rounded-none solid-shadow hover:shadow-lg transition flex flex-col items-center justify-center">
                <img src="https://img.icons8.com/?size=100&id=26083&format=png&color=40C057" alt="Wishlist Icon" class="w-12 h-12 mb-4">
            ...
            <!-- Favorite Card -->
            <div class="photo-card bg-gray-800 p-6 border border-blue-800 fade-in rounded-none solid-shadow hover:shadow-lg transition flex flex-col items-center justify-center">
                <img src="https://img.icons8.com/?size=100&id=10287&format=png&color=FAB005" alt="Favorite Icon" class="w-12 h-12 mb-4">
